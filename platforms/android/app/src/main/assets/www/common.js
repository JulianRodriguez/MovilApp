...
/***/ "./src/app/providers/api-provider/api.provider.ts":
/*!********************************************************!*\
  !*** ./src/app/providers/api-provider/api.provider.ts ***!
  \********************************************************/
...
var ApiProvider = /** @class */ (function () {
    function ApiProvider(httpProvider) {
        ...
        this.baseUrl = 'https://stark-earth-76126.herokuapp.com';
    }
    ApiProvider.prototype.get = function (url, params, options) {
        return this.httpProvider.get(this.baseUrl + "/" + url, params);
    };
    ApiProvider.prototype.post = function (url, params, options) {
        return this.httpProvider.post(this.baseUrl + "/" + url, params, options);
    };
    ApiProvider.prototype.put = function (url, params) {
...
/***/ "./src/app/providers/login-provider/login.provider.ts":
/*!************************************************************!*\
  !*** ./src/app/providers/login-provider/login.provider.ts ***!
  \************************************************************/
...
var LoginProvider = /** @class */ (function () {
    function LoginProvider(api) {
        this.api = api;
    }
    LoginProvider.prototype.doLogin = function (user, password) {
        var base64Credential = btoa(user + ':' + password);
...
/***/ "./src/app/providers/nav-params/nav-params.provider.ts":
/*!*************************************************************!*\
  !*** ./src/app/providers/nav-params/nav-params.provider.ts ***!
  \*************************************************************/
/*! exports provided: NavParamsProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NavParamsProvider", function() { return NavParamsProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var NavParamsProvider = /** @class */ (function () {
    function NavParamsProvider() {
    }
    Object.defineProperty(NavParamsProvider.prototype, "params", {
        get: function () {
            var cloneParams = JSON.parse(JSON.stringify(this._params ? this._params : ''));
            this._params = null;
            return cloneParams;
        },
        set: function (params) {
    ...
    NavParamsProvider = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        })
    ], NavParamsProvider);
    return NavParamsProvider;
}());
